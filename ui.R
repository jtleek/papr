...
navbarPage(title="papr",
           tabPanel("Rate",
                    sidebarLayout(
                      sidebarPanel(
                        h3("Rate the paper"),
                        h4(span(tagList(icon("arrow-right"), "Exciting and Correct", icon("star")))),
                       # em(span(tagList(icon("star"),"Exciting and Correct"))),
                        h4(span(tagList(icon("arrow-up"), "Exciting and Questionable", icon("volume-up")))),
                       # em(span(tagList(icon("volume-up"),"Exciting and Questionable"))),
                        h4(span(tagList(icon("arrow-down"), "Boring and Correct", icon("check")))),
                      #  em(span(tagList(icon("ok",lib="glyphicon"),"Boring and Correct"))),
                       h4(span(tagList(icon("arrow-left"), "Boring and Questionable", icon("trash")))),
